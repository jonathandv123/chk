...
if (!defined('BOT_OWNER_ID'))                      define('BOT_OWNER_ID', '5579729798');

if (!defined('BOT_NAME'))               define('BOT_NAME', 'BETA');
if (!defined('BOT_USERNAME'))               define('BOT_USERNAME', 'BravCc_Bot');
if (!defined('BOT_TOKEN'))                       define('BOT_TOKEN', '7660841735:AAGhvWACcRg84Uq5m986cJTv_lfO6pbrvI0');
